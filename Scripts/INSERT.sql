--Wstawiam inzynierow, ktorzy nie maja powiazania z innymi encjami
...
-- Wstawiam magazynierow i podnosza ich liczbe w odpowiednich magazynach
...
--Wstawiam menagerow ,rowniez bez powiazan z innymi encjami
INSERT INTO employees (employee_id, task, firstname, lastname)
...
--Przydzielam menagerom ich zespol inzynierow
UPDATE employees
SET manager_id = 501
